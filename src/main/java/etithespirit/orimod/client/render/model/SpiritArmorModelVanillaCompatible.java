...
import etithespirit.orimod.client.render.IArmorVisibilityProvider;
 ...
 *
 */
public class SpiritArmorModelVanillaCompatible extends Model implements IArmorVisibilityProvider {
	...
	public SpiritArmorModelVanillaCompatible() {
		this(createBodyLayer().bakeRoot());
	}
	
	public SpiritArmorModelVanillaCompatible(ModelPart org) {
