...
/**
 * A static class that provides a means of adapting power between {@link etithespirit.orimod.energy.ILightEnergyStorage ILightEnergyStorage} and {@link net.minecraftforge.energy.IEnergyStorage IEnergyStorage}
 *
 * @author Eti
 */
