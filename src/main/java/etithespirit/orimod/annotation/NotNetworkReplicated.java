 ...
 * <em>n.b. if a class is decorated with {@link NetworkReplicated @NetworkReplicated} then this changes the implications
 * from "should not" to "do not", unless noted otherwise by docs.</em>
 * </pre>
 */
