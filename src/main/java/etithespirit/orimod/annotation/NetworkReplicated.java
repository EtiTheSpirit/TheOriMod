...
/**
 * The {@link NetworkReplicated} annotation signifies that the attached element is automatically replicated over the network by some system.
 * This is not functional and exists for programmers only. It has a number of implications when used:<br/>
 * <pre>
 *  - When used on a field, the field's value will be synchronized between the server and all clients.
