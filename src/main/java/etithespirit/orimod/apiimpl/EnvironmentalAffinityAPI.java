...
import etithespirit.orimod.api.IEnvironmentalAffinityAPI;
...
public class EnvironmentalAffinityAPI implements IEnvironmentalAffinityAPI {
	 ...
	 * @param evt The tick event.
	 */
	public static void onWorldTickEvent(TickEvent.WorldTickEvent evt) {
		if (evt.phase == TickEvent.Phase.END) {
			EnvironmentalAffinity.sendWorldTickToAll(evt.world);
		}
	}
}
