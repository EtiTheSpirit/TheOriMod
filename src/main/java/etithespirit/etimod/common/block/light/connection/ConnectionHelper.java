...
public final class ConnectionHelper {
	 ...
	 */
	public static boolean hasMutualConnectionInDirection(IBlockReader reader, BlockPos at, Direction dir, boolean anticipateAuto) throws ArgumentNullException, IllegalArgumentException {
		boolean fromAt = hasOutgoingConnectionInDirection(reader, at, dir, anticipateAuto);
		boolean toAt = hasOutgoingConnectionInDirection(reader, at.offset(dir.getNormal()), dir.getOpposite(), anticipateAuto);
		return fromAt && toAt;
	}
