...
public interface IAutoEffect extends IForgeEffect {
	 ...
	 */
	@Nullable ResourceLocation getCustomIcon();
	 ...
	 */
	default @Nonnull String getCustomDurationString(EffectInstance effect) {
	 ...
	 */
	default @Nonnull EffectTextDisplayType getInfoDisplayType() {
	 ...
	 */
	default int getMaxDisplayAmplifier() {
		return 255;
	}
	 ...
	 */
	default @Nullable String getSubtitle() {
		return null;
	}
	 ...
	 */
	default void renderPotionText(EffectInstance effect, DisplayEffectsScreen<?> gui, MatrixStack mStack, int x, int y, float z, boolean useBigRomanNumerals) {
	 ...
	 */
	default EffectInstance constructEffect(int duration) {
	 ...
	 */
	default EffectInstance constructEffect(int duration, int amplifier) {
	 ...
	 */
	default EffectInstance constructEffect(int duration, int amplifier, boolean particles) {
	 ...
	 */
	default EffectInstance constructInfiniteEffect() {
	 ...
	 */
	default EffectInstance constructInfiniteEffect(int amplifier) {
	 ...
	 */
	default EffectInstance constructInfiniteEffect(int amplifier, boolean particles) {
	 ...
	 */
	static int assembleTransparentWhiteColor(float alpha) {
